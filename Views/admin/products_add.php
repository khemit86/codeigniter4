		...
		<div class="main-content">
          ...
          <div class="col-md-12 col-xs-12 padding_opx">
            ...
            <div class="col-md-6 padding_opx">
              <h3 class="panel-title title_h3"><b>  <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Product Add </b></h3>
            </div>
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'ProductName', 'id' => 'ProductName', 'value' =>set_value('ProductName'),   'placeholder' => 'Product Name', 'class'=>"form-control margin_bottom");
		                		...
		                		<label class="col-md-2 text-left padding_opx">
		                	 	  <span> Under Category </span></label>
								     ...
								     // ------------------------------ adm_status form  ---------------------------------  country state	 
											...
											$selected=set_value('ProductCategory');
