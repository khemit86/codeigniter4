		...
		<div class="main-content">
          ...
          <div class="col-md-12 col-xs-12 padding_opx">
            ...
            <div class="col-md-6 padding_opx">
              <h3 class="panel-title title_h3"><b> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i> Product Modify</b></h3>
            </div>

                 <div class="col-md-6 padding_opx">
                  <a href="<?php echo base_url('admin/products/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
            </div>
          </div>
        </div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $session->setFlashdata('products')){  ?>
                                    ...
                                    <?php        
							          ...
							          // ------------------------------ admin form open ---------------------------------
										...
										echo form_open_multipart('admin/products/edit', $attributes);
							     ?>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			   ...
		                			   <div class="col-md-5 form-group padding_opx">
                                        <span style="text-align:left; color:#FF0000; font-size:12px;";><?php echo $validation->showError('ProductName'); ?></span>
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'ProductName', 'id' => 'Name', 'value' =>$productsegory[0]['ProductName'],   'placeholder' => 'Product Name', 'class'=>"form-control margin_bottom");
                             ...
                             <div class="col-md-12 padding_opx">
		                		<label class="col-md-2 text-left padding_opx">
		                	 	  <span> Under Category </span></label>
								     ...
								     // ------------------------------ adm_status form  ---------------------------------  country state	 
											   ...
											   foreach($catid as $val)
											    {
												  $options[$val['CategoryID']] = $val['CategoryName'];
												}
											$selected=$productsegory[0]['ProductCategory'];
											echo form_dropdown('ProductCategory', $options, $selected,'class="form-control margin_bottom"');
                                    ?>
                                      </div>
		                		</div>
                                   ...
                                   <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'Description', 'id' => 'description', 'value'=>$productsegory[0]['Description'],  'placeholder' => 'Description ', 'class'=>"form-control margin_bottom");
                             ...
                             <div class="col-md-12 padding_opx">
                                ...
                                <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                      <?php
											  if($productsegory[0]['Photo']!='') { ?>
                                               <img src="<?php echo base_url('uploads/products/'.$productsegory[0]['Photo']) ?>" width="200px"> <br>
											  <?php } else { ?>
                                 ...
                                 <div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
		                			    ...
		                			    <div class="col-md-5 form-group padding_opx">
                                          <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'SortOrder', 'id' => 'SortOrder', 'value' =>$productsegory[0]['SortOrder'],  'placeholder' => 'Sort Order', 'class'=>"form-control margin_bottom");
                                            echo form_input($data);
                                          ?>
                                      </div>
		                		</div>
                                   ...
                                   <?php
								     // ------------------------------ adm_status form  ---------------------------------
											...
											(
											  ...
											  $selected=$productsegory[0]['Active']	;						
                                 ...
                                 <label class="col-md-2 text-left padding_opx"></label>
                                  <div class="col-md-5 form-group padding_opx">
									...
									<?php
										...
										$data = array('id'  => $productsegory[0]['ProductID'] );
											echo form_hidden($data);
                                        //-------------------------------------------------------------------------------------------------------------------			
