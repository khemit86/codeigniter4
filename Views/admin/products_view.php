...
?>
	<div id="wrapper">
     ...
     <div class="main">
                ...
                <div class="panel-heading col-md-12 col-xs-12 padding_opx panel-heading_1">
					<div class="col-md-12 col-xs-12 padding_opx">
						...
						<div class="col-md-6 padding_opx">
							<h3 class="panel-title title_h3"><strong> <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>  Products View </strong></h3>
						</div>
						 <div class="col-md-6 padding_opx">
                            <a href="<?php echo base_url('admin/products/add'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom"> Add  Products </a>
						 </div>
					</div>
				</div>
			...
			<div class="panel">
				...
				<div class="panel-body">
                     ...
                     <?php                         
						...
						echo form_open_multipart('admin/products/bulk_action', $attributes); 
					?>                             
                 ...
                 <?php 
					foreach($services_products as $val) 
					   {
					     // var $css;
            ...
            <a href="<?php echo base_url('admin/products/edit')."/".$val['ProductID'];  ?>"><img src="<?php echo base_url('public/assets/admin/images/icon-edit.gif') ?>" alt="Edit"></a> | 
            <a onClick="return confirm('Are you sure you want to delete?');" href="<?php  echo base_url('admin/products/delete')."/".$val['ProductID'] ?>"><img src="<?php echo base_url('public/assets/admin/images/icon-delete.gif') ?>"  alt="Delete"></a>
                                    </td>
                                  
                                 <td> 
                                  <?php
									  
                                            $data = array('name'  => 'bb[]', 'id' => 'bb[]',   'value' =>$val['ProductID'],  'checked'=> false, 'class'=>" margin_bottom" );
