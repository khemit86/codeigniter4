                                 ...
                                 <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'page_description', 'id' => 'page_description', 'value'=>set_value('page_description') ,  'placeholder' => 'Page Content  ', 'class'=>"form-control margin_bottom");
                                  ...
                                  <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'meta_description', 'id' => 'meta_description', 'value'=>set_value('meta_description')  ,  'placeholder' => ' ', 'class'=>"form-control margin_bottom");
