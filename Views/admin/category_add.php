		...
		<div class="main-content">
          ...
          <div class="col-md-12 col-xs-12 padding_opx">
            ...
            <div class="col-md-6 padding_opx">
              <h3 class="panel-title title_h3"><b>  <i class="lnr lnr-arrow-right-circle" aria-hidden="true"></i>Category  Add </b></h3>
            </div>

                 <div class="col-md-6 padding_opx">
                  <a href="<?php echo base_url('admin/categeory/view'); ?>" class="btn btn-primary btn-primary1 pull-right margin_bottom">Return Back</a>
            </div>
          </div>
        </div>
...
<!-- Html ##################################################### -->
                   ...
                   <div class="col-md-12 col-xs-12 margin_top">
                                  ...
                                  <?php
                                    if($error = $session->setFlashdata('admin_added')){  ?>
		                		...
		                		<div class="col-md-12 padding_opx">
		                			<label class="col-md-2 text-left padding_opx">
                                       ...
                                       <?php
									      // ------------------------------ Login Id form open ---------------------------------
                                            $data = array('name'  => 'CategoryName', 'id' => 'CategoryName', 'value' =>set_value('CategoryName'),   'placeholder' => 'Category Name', 'class'=>"form-control margin_bottom");
                                   ...
                                   <div class="col-md-12 padding_opx">
                                    ...
                                    <?php
								     // ------------------------------ adm address no Password form open ---------------------------------
                                        $data = array('name'  => 'CategoryDescription', 'id' => 'description', 'value' =>set_value('CategoryDescription'),  'placeholder' => 'Category Description ', 'class'=>"form-control margin_bottom");
